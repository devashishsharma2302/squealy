...
class Suggestions extends Component {
  ...
  shouldRenderSuggestions = (query) => {
    const { props } = this;
    const minQueryLength = ((props.minQueryLength === undefined)? 2: props.minQueryLength)
  ...
  render = () => {
    ...
    if (!props.showSuggestions || suggestions.length === 0 || !shouldRenderSuggestions(props.query)) {
      return null;
    }
