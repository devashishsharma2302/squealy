...
export default class ParamDefinitionModalWrapper extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.editParamState.editParam) {
      ...
      this.refs.optional.value = selectedApiParamDef.optional
                ...
                validations.map((validation, i) => {
                  return (
                    <tr key={'param_row_'+i}>
                      ...
                      <td>{validation.validation_function.kwargs ? validation.validation_function.kwargs.query : validation.validation_function.name}</td>
        ...
        </div>
        {
          this.state.showValidationForm ? 
            <div className='row add-validation-form'>
              ...
              <button type="button" className="btn btn-info" onClick={this.saveValidationHandler}>Add</button>
            </div>
          : null
        }
      </div>
